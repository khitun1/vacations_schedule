...
export default createStore({
    state: {
        ...
        all : [
            ...
            {id: 220, surname: 'Ивановa', name: 'Владислав', lastname: 'Андреевич', start: '10.04.2023', end: '20.04.2023',
                paid: 'Нет', department: 'first', number: 1,
                intersections: 'Да', status: 'Ожидание',},
            {id: 120, surname: 'Алиевa', name: 'Иван', lastname: 'Михайлович', start: '01.05.2023', end: '13.05.2023',
                paid: 'Да', department: 'first', number: 1,
                intersections: 'Нет', status: 'Ожидание',},
